const resources = {
  en: {
    translation: {
      ...
      formDescription:
        "Submitting opens your email client with the message already prepared.",
  ...
  pt: {
    translation: {
      ...
      contactDescription:
        "Escolha o canal que preferir ou envie uma mensagem pelo formulário.",
      ...
      formDescription:
        "O envio abre o seu cliente de e-mail com a mensagem já preenchida.",
      firstNameLabel: "Nome",
