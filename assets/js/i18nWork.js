const resources = {
  en: {
    translation: {
      ...
      frontendText: 'React, Next.js, Angular, JavaScript, TypeScript, HTML, and CSS.',
      ...
      dataTitle: 'Data',
      dataText: 'SQL, PostgreSQL, data modeling, and collaboration on DDL definitions.',
      ...
      currentRole: 'Systems Analyst VI · Full Stack Development and Production Support',
      currentDescription:
  ...
  pt: {
    translation: {
      ...
      frontendTitle: 'Front-end',
      frontendText: 'React, Next.js, Angular, JavaScript, TypeScript, HTML e CSS.',
      backendTitle: 'Integrações e back-end',
      backendText:
        'Java, Spring Boot, Node.js, APIs REST e suporte a serviços consumidos pelo front-end.',
      dataTitle: 'Dados',
      dataText: 'SQL, PostgreSQL, modelagem de dados e colaboração na definição de DDLs.',
      ...
      currentRole: 'Analista de Sistemas VI · Desenvolvimento Full Stack e Sustentação',
      currentDescription:
